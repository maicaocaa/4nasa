...
<body class="w3-metro-light-blue w3-text-white">
    ...
    <script>
        function validatePasswords() {
            ...
            // ---------sino coinciden la propiedad display pasa a block
            if (password !== confirmPassword) {
                errorMessage.style.display = "block"; //  activa desplay block
                submitButton.disabled = true; // deshabilita boton
            } else {
                errorMessage.style.display = "none"; // pone display none
                submitButton.disabled = false; // habilita boton
            }
        }

        //-------muestra a tiempo real los cambios con un Listener
